#import "NIMResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const NIMDeserializationErrorDomainKey = @"NIMDeserializationErrorDomainKey";

NSInteger const NIMTypeMismatchErrorCode = 143553;

NSInteger const NIMEmptyValueOccurredErrorCode = 143509;

NSInteger const NIMUnknownResponseObjectErrorCode = 143528;


@interface NIMResponseDeserializer ()
...
@implementation NIMResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:NIMDeserializationErrorDomainKey code:NIMTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NIMDeserializationErrorDomainKey code:NIMEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NIMDeserializationErrorDomainKey code:NIMUnknownResponseObjectErrorCode userInfo:userInfo];
}
