...
#import "NIMBasicAuthTokenProvider.h"
#import "NIMLogger.h"

@interface NIMDefaultConfiguration ()
...
@implementation NIMDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static NIMDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://api.nimiqstats.com";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [NIMLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [NIMBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
