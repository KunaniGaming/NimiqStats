...
extern NSString * NIMPercentEscapedStringFromString(NSString *string);

extern NSString * const kNIMApplicationJSONType;

@protocol NIMSanitizer <NSObject>
...
@interface NIMSanitizer : NSObject <NIMSanitizer>
