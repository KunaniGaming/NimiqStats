 ...
 */
extern NSString *const NIMResponseObjectErrorKey;


@interface NIMApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<NIMConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<NIMResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<NIMSanitizer> sanitizer;
